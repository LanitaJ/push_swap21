...
/*   Updated: 2020/09/07 12:50:23 by ljerk            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_stack(t_stacks *stacks)
{
	...
	i = 0;
	stacks->flag_c ? ft_printf(YEL"Stack A: "RESET) : ft_printf("Stack A: ");
	while (i < stacks->count_a)
		stacks->flag_c ? ft_printf(YEL"%d "RESET, stacks->a[i++]) :\
						ft_printf("%d ", stacks->a[i++]);
	ft_printf("\n");
	i = 0;
	stacks->flag_c ? ft_printf(MAG"Stack B: "RESET) : ft_printf("Stack B: ");
	while (i < stacks->count_b)
		stacks->flag_c ? ft_printf(MAG"%d "RESET, stacks->b[i++]) :\
